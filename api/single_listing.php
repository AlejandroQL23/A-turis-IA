					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="hoteles.php">about us</a></li>
								<li class="main_nav_item"><a href="mirador-parque.php">offers</a></li>
								<li class="main_nav_item"><a href="edificios.php">news</a></li>
								<li class="main_nav_item"><a href="buscar.php">contact</a></li>
							</ul>
						</div>
	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<ul>
				...
				<li class="menu_item"><a href="hoteles.php">about us</a></li>
				<li class="menu_item"><a href="mirador-parque.php">offers</a></li>
				<li class="menu_item"><a href="edificios.php">news</a></li>
				<li class="menu_item"><a href="buscar.php">contact</a></li>
			</ul>
		</div>
	</div>
						...
						<div class="footer_content footer_blog">
							...
							<div class="footer_blog_item clearfix">
								...
								<div class="footer_blog_content">
									<div class="footer_blog_title"><a href="edificios.php">Travel with us this year</a></div>
							...
							<div class="footer_blog_item clearfix">
								...
								<div class="footer_blog_content">
									<div class="footer_blog_title"><a href="edificios.php">New destinations for you</a></div>
									<div class="footer_blog_date">Nov 29, 2017</div>
								</div>
							</div>
					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							<ul class="footer_nav_list">
								...
								<li class="footer_nav_item"><a href="hoteles.php">about us</a></li>
								<li class="footer_nav_item"><a href="mirador-parque.php">offers</a></li>
								<li class="footer_nav_item"><a href="edificios.php">news</a></li>
								<li class="footer_nav_item"><a href="buscar.php">contact</a></li>
							</ul>
						</div>
					</div>
				</div>
