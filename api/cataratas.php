...
<div class="super_container">
	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="hoteles.php">Hoteles</a></li>
								<li class="main_nav_item"><a href="mirador-parque.php">Naturaleza</a></li>
								<li class="main_nav_item"><a href="edificios.php">Edificios antiguos</a></li>
								<li class="main_nav_item"><a href="restaurantes.php">Restaurantes</a></li>
								<li class="main_nav_item"><a href="senderos.php">Senderos</a></li>
								<li class="main_nav_item"><a href="cataratas.php">Cataratas</a></li>
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/catara.jpg"></div>
		<div class="home_content">
			<div class="home_title">Cataratas</div>
		</div>
	</div>
	...
	<div class="intro">
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="intro_title text-center">Esto es lo más destacado en cataratas</h2>
				</div>
			</div>
			<div class="row intro_items">
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						...
						<div class="intro_item_background" style="background-image:url(images/ct1.jpg)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							<div class="intro_center text-center">
								<h1>Catarata Coliblanco</h1>
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						...
						<div class="intro_item_background" style="background-image:url(images/ct2.webp)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							<div class="intro_center text-center">
								<h1>Cataratas El Torito</h1>
								<div class="intro_price">$</div>
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						...
						<div class="intro_item_background" style="background-image:url(images/ct3.jpg)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							<div class="intro_center text-center">
								<h1>La Gruta Bohemia</h1>
								<div class="intro_price">$</div>
...
<footer class="footer">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 footer_column">
					<div class="footer_col">
						<div class="footer_content footer_about">
							...
							<p class="footer_about_text">Turiste es una aplicación para que puedas encontrar la mejor opción de lugares, según tus preferencias</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 footer_column">
					<div class="footer_col">
						<div class="footer_title">Informacíon de contacto</div>
