	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="edificios.php">Edificios antiguos</a></li>
								<li class="main_nav_item"><a href="edificios.php">Restaurantes</a></li>
								<li class="main_nav_item"><a href="edificios.php">Senderos</a></li>
								<li class="main_nav_item"><a href="edificios.php">Cataratas</a></li>
								<li class="main_nav_item"><a href="buscar.php">busqueda</a></li>
				</ul>
		</div>
	</div>
		...
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<div class="owl-item home_slider_item">
					...
					<div class="home_slider_background" style="background-image:url(images/4.jpg)"></div>
				...
				<!-- Slider Item -->
				<div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(images/6.webp)"></div>
